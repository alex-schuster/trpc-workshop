...
const create = publicProcedure.input(createPassengerInput).mutation(async ({ ctx, input }) => {
...
const getOne = publicProcedure.input(z.string().cuid2()).query(async ({ ctx, input }) => {
